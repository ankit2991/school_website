...
function Employee_Salary() {
    ...
    const columns = [
        ...
        { header: "Effect Date", shortHeader: "Effect Date", accessor: "date" },
    ]
    const data = [
        { id: 1, name: "Harsh", date:"01-Oct-2023", },
        { id: 2, name: "Purav", date:"02-Jun-2022", },    
    ];

    return (
        <div className="w-full h-full bg-white flex flex-col px-4 py-2">
            <div className="flex justify-between items-center gap-x-4 mb-5">
                <Heading label={"Employee Basic Salary Master"} style={"text-[22px] sm:text-3xl"} />
                <Buttons click={() => navigate("/Employee-Salary2")} label={"Add"} style='whitespace-nowrap h-10'/>                    
            </div>
            ...
            <div className="flex justify-end">
                <Buttons click={() => navigate("/Employee-Salary2")} label={"Search"} />                    
            </div>
