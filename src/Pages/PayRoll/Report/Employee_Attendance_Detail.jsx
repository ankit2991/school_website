...
function Employee_Attendance_Detail() {
    ...
    const data = [
        ...
        <div className="w-full h-full bg-white flex flex-col px-4 py-2">
            <div className="flex justify-between items-center gap-x-4 mb-5">
                <Heading label={"Employee Attendance Report"} style={"text-[22px] sm:text-3xl"} />
            </div>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-3 mb-5 w-full">
                <Options label={"Employee"} optionMsg="Select Employee Name" options={["Varun Yadav", "Arush"]} />
                <FormInput label={"Date"} type='date' />
                <CheckBox label={"Summary"} labelClass='text-[20px] sm:mt-8' checkstyle={"sm:mt-8"} name={""}
            ...
            <Table 
                ...
                actions={(row) => (<CheckBox label={""} name={""} checked={agree2} onChange={(e) => setAgree2(e.target.checked)}/>)}
            />
