    ...
    <div className="w-full h-full bg-white flex flex-col px-4 py-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-5 w-full">
        <Options
          label={"Ledger"}
          name={""}
          optionMsg="Select Ledger"
          options={["Sales Account", "Secured Loans"]}
        />
        <CheckBox
          label={"Is Special Case"}
          labelClass="text-[20px] sm:mt-8"
          checkstyle={"sm:mt-8"}
          name={""}
          checked={agree}
        ...
        <Options
          label={"Apply To"}
          name={""}
          optionMsg="Select Apply"
          options={["All Student", "New Student"]}
        />
        <Options
          label={"Fees Mode"}
          name={""}
          optionMsg="Select Fees Mode"
