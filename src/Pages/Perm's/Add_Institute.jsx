...
function Add_Institute() {
    ...
    const data = [
        { id: 1,  name: "KMMPS", },
        { id: 2,  name: "Kesharam Memorial Manakchand Public School", },    
    ];
    ...
    return (
        <div className="w-full h-full bg-white flex flex-col px-4 py-2">
            <div className="flex justify-between items-center gap-x-4 mb-5">
                ...
                <Buttons click={() => navigate("/Add-Institute2")} label={"Add"} style='whitespace-nowrap h-10'/>                    
            </div>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-5 w-full">
                <FormInput label={"Institute"} placeholder={"Enter Institute Name"} />
            </div>
            
            <div className="flex justify-end">
                <Buttons click={() => navigate("/Add-Institute2")} label={"Search"} />                    
            </div>
