    ...
    return (
        <div className="w-full h-full bg-white flex flex-col px-4 py-2">
            <div className="flex justify-between items-center gap-x-4 mb-5">
                <Heading label={"Student Subject Allocation"} style={"text-[22px] sm:text-3xl"} />
                <Buttons click={() => navigate("/Subject-Allocation2")} label={"Add"} style='whitespace-nowrap h-10'/>                    
            </div>
            ...
            <div className="flex justify-end">
                <Buttons click={() => navigate("/Subject-Allocation2")} label={"Search"} />                    
            </div>
