...
function Student_Attendance() {
  ...
  const columns = [
    ...
    { header: "Env. No.", accessor: "env" },
    { header: "Roll No.", accessor: "roll" },
    { header: "Total Attendance", accessor: "tot" },
    { header: "Attendance No.", accessor: "att" },
  ];
  ...
  return (
    <div className="w-full h-full px-4 py-2 bg-white flex flex-col">
      ...
      <div className="grid grid-rows-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-2">
        <Options label={"Class"} optionMsg="Select Class" options={["Nur", "K.G.", "Prep"]} />
        <Options label={"Exam"} optionMsg="Select Exam" options={["Unit Test", "Yearly Exam", "Annual Exam"]} />
        <Options label={"Month"} optionMsg="Select Month" options={["Jan", "Feb"]} />
      </div>
      ...
      <div className="hidden lg:flex gap-6 mb-5 w-full">
        ...
        <div className="flex-[1]">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-5 w-full">
            ...
            <FormInput label={"Total Attendance"} placeholder={"Enter Total Attendance"} />
            <FormInput label={"Attendance Number"} placeholder={"Enter Attendance No."} />
            <CheckBox label={"Copy to all Student"} labelClass="text-[20px] md:mt-8" checkstyle={"md:mt-8"} name={""} checked={sure} 
