    ...
    return (
        <div className="w-full h-full bg-white flex flex-col px-4 py-2">
            <div className="flex justify-between items-center gap-x-4 mb-5">
                <Heading label={"Student T.C. Details"} style={"text-[22px] sm:text-3xl"} />
                <Buttons label="Print" click={() => { window.open("/pdf/7TcReportViewer.pdf", "_blank"); }} style='whitespace-nowrap h-10'/>
            </div>
