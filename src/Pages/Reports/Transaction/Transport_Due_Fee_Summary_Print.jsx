...
const columns = [
  { label: "SrNo", key: "srno", width: "8%" },
  { label: "Name", key: "name", width: "16%" },
  { label: "Father Name", key: "fname", width: "16%" },
  { label: "Mobile No", key: "fno", width: "11%" },
  { label: "Class", key: "class", width: "9%" },
  { label: "Vehicle", key: "vehicle", width: "12%" },
  { label: "Stop Name", key: "stop", width: "14%" },
...
export default function Transport_Due_Fee_Summary_Print() {
          ...
          return (
            <Page size="A4" style={styles.page} key={pageIndex}>
              ...
              <View style={styles.table}>
                ...
                {isLastPage && (
                  <View style={styles.row}>
                    <Text style={[styles.totcell, styles.bold, { width: "72.27%" }]}>
                      TOTAL
                    </Text>
                    <Text style={[styles.totcell, styles.right, styles.bold, { width: "9.25%" }]}>
                      {totalFees.toLocaleString()}
                    </Text>
                    <Text style={[styles.totcell, styles.right, styles.bold, { width: "9.23%" }]}>
