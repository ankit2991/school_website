...
export default function Due_Fee_Print() { 
                        ...
                        <View style={styles.grid}> 
                            {pageData.map((r, index) => ( 
                                <View style={styles.box} key={index}> 
                                    ...
                                    <Text style={styles.underline}>Fee Due Reminder</Text> 
                                    ...
                                    <View style={styles.amountRow}> 
                                        <Text style={styles.amountLabel}> Due Tuition Fee (up to ) : </Text> 
                                        <Text style={styles.amountValue}> {r.due} </Text> 
                                    </View> 
                                    
                                    <Text style={styles.note}> 
                                        Please pay the required amount to avoid late fees. 
                                    </Text> 
                                </View> 
                            ))} 
                        </View> 
