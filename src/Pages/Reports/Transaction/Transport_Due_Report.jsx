...
function Transport_Due_Report() {
    ...
    const data = [
        { id: 1, serial: "01", name: "Ajay", class: "Nur", fname: "Rman Thakur",  fno: "1234567890", no:"RJ 19 ED 2534", stop:"School", tot:"400", dep:"100", due:"300" },
        { id: 2, serial: "02", name: "Ajay", class: "Nur", fname: "Rman", fno: "1234567540", no:"RJ 19 FY 7856", stop:"School", tot:"1000", dep:"500", due:"500" },
        { id: 3, serial: "03", name: "Viren", class: "Nur", fname: "Devanh Bhalla",  fno: "1234567890", no:"RJ 19 SC 9078", stop:"School", tot:"800", dep:"600", due:"200" },
        { id: 4, serial: "04", name: "anuj", class: "Nur", fname: "aditya", fno: "1234567890", no:"RJ 19 RG 3244", stop:"School", tot:"1000", dep:"500", due:"500" },
        { id: 5, serial: "05", name: "somya", class: "Nur", fname: "Devanh",  fno: "1234567867", no:"RJ 19 HR 8654", stop:"School", tot:"900", dep:"500", due:"400" },
    ];
    ...
    return (
        <div className="w-full h-full bg-white flex flex-col px-4 py-2">
            <div className="flex justify-between items-center gap-x-4 mb-5">
                <Heading label={"Transport Due Report"} style={"text-[22px] sm:text-3xl"} />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-3 mb-5 w-full ">
                ...
                <div className="flex sm:mt-8">
                    <CheckBox label={"Only Last Balance"}labelClass='text-[20px]' name={""} checked={agree} onChange={(e) => setAgree(e.target.checked)} />
                </div>
            </div>
