...
export default function Transport_Due_Fee_Print() { 
                        ...
                        <View style={styles.grid}> 
                            {pageData.map((r, index) => ( 
                                <View style={styles.box} key={index}> 
                                    ...
                                    <Text style={styles.underline}>Transport Due Reminder</Text> 
                                    ...
                                    <View style={styles.amountRow}> 
                                        <Text style={styles.amountLabel}> Due Bus Fee (up to ) : </Text> 
