    ...
    return (
        <div className="w-full h-full bg-white flex flex-col px-4 py-2">
            <div className="flex justify-between items-center gap-x-4 mb-5">
                <Heading label={"Certificate Print"} style={"text-[22px] sm:text-3xl"} />
                <Buttons click={() => { window.open("/pdf/1EnqReportViewer.pdf", "_blank"); }} label={"CC Print"} style='whitespace-nowrap h-10'/>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-3 mb-5 w-full">
                ...
                <FormInput label={"Fee"} placeholder={"Enter Fee"} />
            </div>
            ...
            {/* <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-3 mt-5"> */}
                <Buttons label={"Clear"}/>
                <Buttons label={"D.O.B. Print"}/>
                <Buttons label={"Fee Print"}/>
            </div>
