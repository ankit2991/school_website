...
function Create_Student2() {
  ...
  const handleSave = async () => { 
    ...
    const payload = { 
      ...
      tcNo: numOrZero(formData.tcNo), tcDate: dateOrEmpty(formData.tcDate), NsoDate: formData.NsoDate ? dateOrEmpty(formData.NsoDate) : "", 
      ...
      fAadhar: numOrZero(formData.fAadhar), mAadhar: numOrZero(formData.mAadhar), jAadhar: numOrZero(formData.jAadhar), 
      ...
      panNum: numOrZero(formData.panNum), ApparId: numOrZero(formData.ApparId), address: strOrEmpty(formData.address), 
      address2: strOrEmpty(formData.address2), mail: strOrEmpty(formData.mail), aadharNo: numOrZero(formData.aadharNo), 
