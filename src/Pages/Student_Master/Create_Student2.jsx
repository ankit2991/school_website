...
function Create_Student2() {
    ...
    async function fetchStudentDetails() {
      try {
        ...
        setFormData((prev) => ({
          ...
          studtype: d.F_StudntType?.toString() || "",
          casteId: d.F_CastMaster?.toString() || "",
          caste: d.Caste || "",
          addDate: apiDateToInput(d.AdmissionDate),
          joinDate: apiDateToInput(d.JoinDate),
          feeCalDate: apiDateToInput(d.FeeCalDate),
          lstSchl: d.LastSchool || "",
          lstsess: d.LastPassoutSession || "",
          fName: d.FatherName || "",
          fOcc: d.Foccupation || "",
          fNum: d.FMobileNo || "",
          mNane: d.MotherName || "",
          mOcc: d.Moccupation || "",
          mNum: d.MMobileNo || "",
          guardian: d.GaurdianName || "",
          guardianOcc: d.Goccupation || "",
          guardianNum: d.GMobileNo || "",
          guardianRel: d.Grelation || "",
          phone: d.Phoneno || "",
          fatherInc: d.FatherIncome?.toString() || "",
          ...
          address2: d.Address2 || "",
          mail: d.EmailId || "",
          lastBal: d.LastBalance?.toString() || "",
          translastbal: d.TransportLastBalance?.toString() || "",
          feeDis: d.FeeDiscount?.toString() || "",
          addFee: d.AdmissionFee?.toString() || "",
          quesMoney: d.QuestionMoney?.toString() || "",
          remark: d.Remarks || "",
          left: d.Leave ? "1" : "0",
          leaveRes: d.LeaveReason || "",
          NsoDate: apiDateToInput(d.NSODate),
          isNew: "0",
          tcNo: d.TcNo || "",
          tcDate: apiDateToInput(d.TcDate),
          nation: d.Nationality || "",
          aadharNo: d.STIdCardNo || "",
          fAadhar: d.FatherAadharNo || "",
          mAadhar: d.MotherAadharNo || "",
          jAadhar: d.JanaadharNo || "",
          panNum: d.PEN || "",
          ApparId: d.ApparId || "",
        }));
  ...
  const handleSave = async () => {
    ...
    const payload = {
      instId: numOrZero(instId),
      sessId: numOrZero(sessId),
...
enroNo: numOrZero(serialNo.enrollNo),
      ...
      addDate: dateOrEmpty(formData.addDate),
      joinDate: dateOrEmpty(formData.joinDate),
      feeCalDate: dateOrEmpty(formData.feeCalDate),
      tcNo: strOrEmpty(formData.tcNo),
      tcDate: dateOrEmpty(formData.tcDate),
      NsoDate: formData.NsoDate ? dateOrEmpty(formData.NsoDate) : "",
      studtype: numOrZero(formData.studtype),
      casteId: numOrZero(formData.casteId),
      caste: strOrEmpty(formData.caste),
      lstSchl: strOrEmpty(formData.lstSchl),
      lstclId: numOrZero(lastClassId),
      clid: numOrZero(currentClassId),
      lstsess: strOrEmpty(formData.lstsess),
      isNew: numOrZero(formData.isNew),
      nation: strOrEmpty(formData.nation),
      fName: strOrEmpty(formData.fName),
      fOcc: strOrEmpty(formData.fOcc),
      fNum: strOrEmpty(formData.fNum),
      mNane: strOrEmpty(formData.mNane),
      mOcc: strOrEmpty(formData.mOcc),
      mNum: strOrEmpty(formData.mNum),
      fAadhar: strOrEmpty(formData.fAadhar),
      mAadhar: strOrEmpty(formData.mAadhar),
      jAadhar: strOrEmpty(formData.jAadhar),
      guardian: strOrEmpty(formData.guardian),
      guardianOcc: strOrEmpty(formData.guardianOcc),
      guardianNum: strOrEmpty(formData.guardianNum),
      guardianRel: strOrEmpty(formData.guardianRel),
      phone: strOrEmpty(formData.phone),
      fatherInc: numOrZero(formData.fatherInc),
      birthplace: strOrEmpty(formData.birthplace),
      bloodgroup: strOrEmpty(formData.bloodgroup),
      bodysign: strOrEmpty(formData.bodysign),
      panNum: strOrEmpty(formData.panNum),
      ApparId: strOrEmpty(formData.ApparId),
      address: strOrEmpty(formData.address),
      address2: strOrEmpty(formData.address2),
      mail: strOrEmpty(formData.mail),
      aadharNo: strOrEmpty(formData.aadharNo),
      lastBal: formData.lastBal?.trim() || "0",
      translastbal: formData.translastbal?.trim() || "0",
      feeDis: formData.feeDis?.trim() || "0",
      addFee: formData.addFee?.trim() || "0",
      quesMoney: formData.quesMoney?.trim() || "0",
      remark: strOrEmpty(formData.remark),
      left: numOrZero(formData.left),
      leaveRes: strOrEmpty(formData.leaveRes),
    };
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setFormData((prev) => ({
        ...
        aadharNo: d.AaNo || "",
        remark: d.Remarks || "",
        translastbal: d.TLBala || "",
        addFee: d.AdmissionFee || "",
        quesMoney: d.QuestionMoney || "",
        NsoDate: apiDateToInput(d.NSODate),
      }));
...
/>
        ...
        />
        <FormInput
          label={"Fee Calculate Date"}
          type="date"
          name="feeCalDate"
          value={formData.feeCalDate}
          onChange={handleChange}
        />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-5 w-full">
        ...
        <Options
          ...
          labelKey="ClassName"
          value={lastClassId}
          onChange={(e) => setLastClassId(e.target.value)}
        />
        <FormInput
          label={"T.C. No."}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6 w-full">
        ...
        <FormInput
          label={"Body Sign"}
          placeholder={"Enter Body Sign"}
          name="bodysign"
          value={formData.bodysign}
          onChange={handleChange}
        />
        <FormInput
          label={"PAN Card No."}
