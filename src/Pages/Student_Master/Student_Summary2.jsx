  ...
  return (
    <div className="w-full h-full px-4 py-2 bg-white flex flex-col">
      ...
      {student ? (
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4 mb-4">
            <FormInput label={"Student ID"} value={student.id} readOnly />
            <FormInput label={"Student Name"} value={student.name} readOnly />
            <FormInput label={"Father Name"} value={student.fname} readOnly />
            <FormInput label={"Mother Name"} value={student.mname} readOnly />
            <FormInput label={"Class"} value={student.class} readOnly />
            <FormInput label={"Mobile Number"} value={student.fno} readOnly />
          </div>
        </>
      ) : (
