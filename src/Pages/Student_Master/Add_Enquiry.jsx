    ...
    getEnquiryDetail(editEqId)
      .then((res) => {
        ...
        setFormData({
          eqid: d.Id,
          eqno: d.EnquireNo,
          enqDate: apiDateToInput(d.EnquireDate),
          ffees: d.FormFees || "",
          classId: d.F_ClassMaster,
          casteId: d.F_CastMaster,
          name: d.Name,
          gender: d.Gender,
          dob: apiDateToInput(d.DOB),
          father: d.FatherName,
          fatherOcc: d.Foccupation,
          fatherMobile: d.FMobileNo,
          mother: d.MotherName,
          motherOcc: d.Moccupation,
          motherMobile: d.MMobileNo,
          guardian: d.GaurdianName,
          guardianOcc: d.Goccupation,
          guardianMobile: d.GMobileNo,
          guardianRel: d.Grelation,
          phone: d.Phoneno,
          fatherInc: d.FatherIncome,
          ...
          remark: d.Remarks,
          lastschool: d.LastSchool,
          lastclass: d.F_LastClass,
