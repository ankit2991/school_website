...
function Promote_Student() {
    ...
    const data = [
        { id: 1, serial: "01", name: "Ajay", fname: "Rman Thakur",  mname:"Shreya", class: "Nur", dob: "10-Dec-2022", addate: "26-may-2024", add: "221, Shanti Nagar, Near Hanuman Mandir, Jaipur, Rajasthan – 302012", fno: "1234567890", },
        { id: 2, serial: "02", name: "Ajay", fname: "Rman", mname:"Priya", class: "Nur", dob: "01-jan-2021", addate: "10-Dec-2023", add: "Flat No. 14, Green Valley Apartments, Sector 21, Gandhinagar, Gujarat – 382021", fno: "1234567540", },
        { id: 3, serial: "03", name: "Viren", fname: "Devanh Bhalla",  mname:"Kiya", class: "Nur", dob: "31-sep-2023", addate: "03-feb-2024", add: "3rd Floor, Lakeview Residency, Green Valley Apartments, Sector 21, Gandhinagar Whitefield, Bengaluru, Karnataka – 560066", fno: "1234567890", },
        { id: 4, serial: "04", name: "anuj", fname: "aditya", mname:"Teena", class: "Nur", dob: "26-may-2023", addate: "10-Dec-2025", add: "House No. 77, Palm Avenue, Vyttila, Kochi, Kerala – 682019", fno: "1234567890", },
        { id: 5, serial: "05", name: "somya", fname: "Devanh",  mname:"Shalini", class: "Nur", dob: "03-feb-2022", addate: "01-jan-2024", add: "Plot No. 9, Palm Avenue, Vyttila, Ocean Pearl Apartments, Juhu, Near Hanuman Mandir, Jaipur, Rose Garden Society, Alkapuri, Vadodara, Gujarat – 390007", fno: "1234567867", },
    ];
    ...
    return (
        <div className="w-full h-full bg-white flex flex-col px-4 py-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-6 gap-y-3 mb-5 w-full">
                ...
                <Options label={"Session"} name={""} optionMsg="Select Session" options={["2024-2025", "2023-2024", "2022-2023"]} />
                <Options label={"Promote Class"} name={""} optionMsg="Select Class" options={["Nur", "K.G.", "Prep"]} />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-x-6 mb-5 w-full">
                <div className="w-full sm:flex-1">
                    <div className="flex flex-col flex-1">
                        ...
                        <Options label={""} name={""} optionMsg="Select Institute" options={[ "Kesharam Memorial Manakchand Public School", "KMMPS"]} />
                    </div>
                </div>
...
export default Promote_Student
