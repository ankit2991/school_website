...
import { getVehicleProviderDetail, getVehicleProviderInsertUpdate } from '../../services/api'
...
function Vehicle_Provider2() { 
    ...
    const fetchProviderDetail = async () => { 
        try { 
            setSearched(true) 
            const res = await getVehicleProviderDetail(vehId, instId, sessId,) 
    ...
    // =================== SAVE / UPDATE ====================== 
        ...
        try {
            ...
            const res = await getVehicleProviderInsertUpdate(
                vehId || 0, form.name, form.address, form.contact, 
